//Auto code generated from xml definition 2022-04-28 08:31:55.8497238 -0400 EDT
//RptQuery
      ...
      children: [
        ...
        TextButton.icon(
            onPressed: () async {
              ...
              // if (r != null) {
              //   list.add(m);
              //   if (BlocProvider.of<RptQueryCubit>(context).state
              //       is BaseEmpty) {
              //     BlocProvider.of<RptQueryCubit>(context)
