//Auto code generated from xml definition 2022-05-03 19:12:06.7838856 -0400 EDT
//User
...
import 'package:ez_search_ui/modules/user/user.edit.dart';
import 'package:ez_search_ui/modules/booking_type/user.data.model.dart';
    ...
    return Padding(
      ...
      allowSorting: true,
        ...
        columns: <GridColumn>[ 
          ...
          UIHelper.buildGridColumn(label: 'First Name', columnName: 'firstName'), 
         
          UIHelper.buildGridColumn(label: 'Last Name', columnName: 'lastName'), 
